...
- **[Conferences Are Work](conferences-are-work.md)** *(academia, conferences, career)*: Choosing which conferences to attend, preparing for one, conducting yourself well during it, and following up afterward, with a closing section on adapting the advice to your temperament

## How this repo is organized

- Every guide is a single Markdown file, named in kebab-case (for example, `using-llms-with-r.md`).
- The index above is the source of navigation. A guide that spans more than one subject (say, R and LLMs) is listed once, with all of its subjects shown as topic tags so that nothing has to be filed under a single category.
...
- [@TedPavlic on YouTube](https://www.youtube.com/@TedPavlic): Lectures and short video tutorials, including the [Office Hours](https://www.youtube.com/playlist?list=PLXBbGVSkQJqEFKCGlTbzBnvf96DRJ6_gi) playlist of general topics not directly associated with a course

## License

Unless noted otherwise, content is released under the MIT License. See [LICENSE](LICENSE).

Copyright © 2026 Theodore P. Pavlic.
