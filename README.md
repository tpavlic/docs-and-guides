...
- The index above is the source of navigation. A guide that spans more than one subject (say, R and LLMs) is listed once, with all of its subjects shown as topic tags, so nothing has to be filed under a single category.
